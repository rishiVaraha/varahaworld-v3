      ...
      <Wrapper className="my-4 flex min-h-screen flex-col gap-4 sm:my-8 lg:my-12 lg:min-h-0 lg:gap-10">
        ...
        <div className="flex flex-col justify-between gap-4 sm:gap-5 md:gap-10 lg:flex-row lg:gap-[150px] xl:gap-[180px]">
          ...
          >
            ...
            <div className="mt-5">
              <AnimatedButton
                className="hidden h-10 w-[150px] items-center justify-center rounded-lg px-4 font-sans text-sm uppercase text-primary-foreground lg:flex lg:h-12 lg:w-[170px]"
                type="submit"
              >
                Submit
                <ArrowForward />
